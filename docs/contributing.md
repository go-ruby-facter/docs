...
Contributions are welcome. `go-ruby-facter/facter` is built to a small set of
...
The library is in [`github.com/go-ruby-facter/facter`](https://github.com/go-ruby-facter/facter).
This documentation site is in [`github.com/go-ruby-facter/docs`](https://github.com/go-ruby-facter/docs).
