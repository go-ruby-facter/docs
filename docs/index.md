# go-ruby-facter documentation

**Ruby Facter API adapter over the pure-Go go-facter engine (CGO=0).**

`go-ruby-facter/facter` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `facter`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-facter/facter`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `facter`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-facter/facter
```
...
| Repo | What it is |
| --- | --- |
| [`facter`](https://github.com/go-ruby-facter/facter) | the library — Ruby's `facter` in pure Go |
| [`docs`](https://github.com/go-ruby-facter/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-facter.github.io`](https://github.com/go-ruby-facter/go-ruby-facter.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-facter/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-facter/facter](https://github.com/go-ruby-facter/facter).
