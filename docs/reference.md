...
The public API lives at the module root (`github.com/go-ruby-facter/facter`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `facter`, while the surface follows
...
```go
import "github.com/go-ruby-facter/facter"
```
...
- **[pkg.go.dev/github.com/go-ruby-facter/facter](https://pkg.go.dev/github.com/go-ruby-facter/facter)**

The module's [README](https://github.com/go-ruby-facter/facter#readme) carries worked
